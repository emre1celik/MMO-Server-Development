...
<div class="dmn-content">
   <div class="dmn-page-box">
      <div class="dmn-page-title">
         <h1 style="font-family: Philosopher, sans-serif;color:white;">Highscores - Devil Square</h1>
      </div>
      <div class="dmn-page-content">
         ...
         <div class ="row">
            <div class="col-12">
               ...
               <div class="d-flex justify-content-center" style="font-family: Philosopher, sans-serif;color:white;">
                  ...
                  <a href="./highscore-ds.php" class="btn btn-primary" style="font-weight:bold;box-shadow: 0px 0px 5px #fff;"><img src="./images/ds.png" style="width: 35px; height 35px;">&nbsp;&nbsp;Devil Square</a>&nbsp;&nbsp;
         ...
         try {
            $sql = "SELECT rank.event_id, rank.char_id, rank.score, info.name, info.race FROM characters.event_ranking rank INNER JOIN characters.character_info info WHERE rank.char_id = info.guid  AND rank.event_id = 1 ORDER BY rank.score DESC LIMIT 50";
            ...
            if (mysqli_num_rows($result) > 0) {
               ...
               while($row = mysqli_fetch_assoc($result)) {
                  ...
                  if ($nr == 1) {
                     echo "<tr><td><img src='./images/gold-cup.png' style='width:30px; height:30px;'></td><td><img src='./images/classes/icon/".$row["race"].".png' style='width:30px; height:30px;'> ".$classname."</td><td>".$row["name"]."</td><td>".number_format($row["score"])."</td></tr>";
                 
                  } else if ($nr == 2) {
                     echo "<tr><td><img src='./images/silver-cup.png' style='width:30px; height:30px;'></td><td><img src='./images/classes/icon/".$row["race"].".png' style='width:30px; height:30px;'> ".$classname."</td><td>".$row["name"]."</td><td>".number_format($row["score"])."</td></tr>";
                 
                  } else if ($nr == 3) {
                     echo "<tr><td><img src='./images/bronze-cup.png' style='width:30px; height:30px;'></td><td><img src='./images/classes/icon/".$row["race"].".png' style='width:30px; height:30px;'> ".$classname."</td><td>".$row["name"]."</td><td>".number_format($row["score"])."</td></tr>";

                  } else {
                  echo "<tr><td>#".$nr."</td><td><img src='./images/classes/icon/".$row["race"].".png' style='width:30px; height:30px;'> ".$classname."</td><td>".$row["name"]."</td><td>".number_format($row["score"])."</td></tr>";
                  }
                  $nr++;
               }
            } else {
