...
<div class="dmn-content">
   <div class="dmn-page-box">
      <div class="dmn-page-title">
         <h1 style="font-family: Philosopher, sans-serif;color:white;">Highscores - Doppelganger</h1>
      </div>
      <div class="dmn-page-content">
         ...
         <div class ="row">
            <div class="col-12">
               ...
               <div class="d-flex justify-content-center" style="font-family: Philosopher, sans-serif;color:white;">
                  ...
                  <a href="./highscore-dg.php" class="btn btn-primary" style="font-weight:bold;box-shadow: 0px 0px 5px #fff;"><img src="./images/dg.png" style="width: 35px; height 35px;">&nbsp;&nbsp;Doppelganger</a>
               </div>
            </div>
         </div>
         <hr>
         ...
         try {
            $sql = "SELECT rank.event_id, rank.char_id, rank.score, info.name, info.race FROM characters.event_ranking rank INNER JOIN characters.character_info info WHERE rank.char_id = info.guid  AND rank.event_id = 3 ORDER BY rank.score DESC LIMIT 50";
