...
<div class="dmn-content">
   <div class="dmn-page-box">
      <div class="dmn-page-title">
         <h1 style="font-family: Philosopher, sans-serif;color:white;">Highscores - Goblin Points Currency</h1>
      </div>
      <div class="dmn-page-content">
         ...
         <div class ="row">
            <div class="col-12">
               ...
               <div class="d-flex justify-content-center" style="font-family: Philosopher, sans-serif;color:white;font-weight:bold;">
                  ...
                  <a href="./highscore-goblinpoints.php" class="btn btn-primary" style="font-weight:bold;box-shadow: 0px 0px 5px #fff;"><img src="./images/goblinpoints.png" style="width: 35px; height 35px;">&nbsp;Goblin Points</a>
               </div>
               <br>
         ...
         try {
            $sql = "SELECT race, name, goblin_points FROM characters.character_info ORDER BY goblin_points DESC LIMIT 50";
            ...
            if (mysqli_num_rows($result) > 0) {
               ...
               while($row = mysqli_fetch_assoc($result)) {
                  ...
                  if ($nr == 1) {
                     echo "<tr><td><img src='./images/gold-cup.png' style='width:30px; height:30px;'></td><td><img src='./images/classes/icon/".$row["race"].".png' style='width:30px; height:30px;'> ".$classname."</td><td>".$row["name"]."</td><td>".number_format($row["goblin_points"])."</td></tr>";
                 
                  } else if ($nr == 2) {
                     echo "<tr><td><img src='./images/silver-cup.png' style='width:30px; height:30px;'></td><td><img src='./images/classes/icon/".$row["race"].".png' style='width:30px; height:30px;'> ".$classname."</td><td>".$row["name"]."</td><td>".number_format($row["goblin_points"])."</td></tr>";
                 
                  } else if ($nr == 3) {
                     echo "<tr><td><img src='./images/bronze-cup.png' style='width:30px; height:30px;'></td><td><img src='./images/classes/icon/".$row["race"].".png' style='width:30px; height:30px;'> ".$classname."</td><td>".$row["name"]."</td><td>".number_format($row["goblin_points"])."</td></tr>";

                  } else {
                  echo "<tr><td>#".$nr."</td><td><img src='./images/classes/icon/".$row["race"].".png' style='width:30px; height:30px;'> ".$classname."</td><td>".$row["name"]."</td><td>".number_format($row["goblin_points"])."</td></tr>";
                  }
                  $nr++;
               }
            } else {
