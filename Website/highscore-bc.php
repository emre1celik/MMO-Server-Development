...
<div class="dmn-content">
   <div class="dmn-page-box">
      <div class="dmn-page-title">
         <h1 style="font-family: Philosopher, sans-serif;color:white;">Highscores - Bloodcastle</h1>
      </div>
      <div class="dmn-page-content">
         ...
         <div class ="row">
            <div class="col-12">
               ...
               <div class="d-flex justify-content-center" style="font-family: Philosopher, sans-serif;color:white;">
                  <a href="./highscore-bc.php" class="btn btn-primary" style="font-weight:bold;box-shadow: 0px 0px 5px #fff;"><img src="./images/bc.png" style="width: 35px; height 35px;">&nbsp;&nbsp;Blood Castle</a>&nbsp;&nbsp;
         ...
         try {
            $sql = "SELECT rank.event_id, rank.char_id, rank.score, info.name, info.race FROM characters.event_ranking rank INNER JOIN characters.character_info info WHERE rank.char_id = info.guid  AND rank.event_id = 0 ORDER BY rank.score DESC LIMIT 50";
