...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT guid, account, password, email FROM accounts WHERE account = ? AND password = SHA2($passwordHash, 256)";
         ...
         <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navcol-2" style="width: 100%;margin: 0px;margin-right: 0px;margin-left: 0px;">
               <ul class="navbar-nav" style="width: 100%;">
                  ...
                  <li class="nav-item"><a class="nav-link" href="https://discord.gg/UPRBcRaXW8" target="_blank" style="font-family: Philosopher, sans-serif;font-size: 24px;width: 100%;height: 100%;margin-right: 55px;">Discord</a></li>
               </ul>
            </div>
      ...
      <div class="dmn-content">
	   <div class="dmn-page-login-box">
         <div class="dmn-page-title">
            <h1 style="color: white;font-family: Philosopher, sans-serif;">Account Login</h1>
         </div>
		<div class="dmn-page-content">
			<div class="row">
               ...
               ?>
					<form id="login_form_page" class="login_form" method="post">
						<div class="form-group">
							<label class="control-label" style="color: white;">Username</label>
							<input type="text" class="form-control" name="username" id="login_input_page" value="" style="background: rgba(0,0,0,0.35); border: none;">
						</div>
						<div class="form-group">
							<label class="control-label" style="color: white;">Password</label>
							<input type="password" class="form-control" name="password" id="password_input_page" value="" style="background: rgba(0,0,0,0.35); border: none;">
						</div> 
						<div class="form-group">
							<div class="d-flex justify-content-center align-items-center"><button type="submit" class="btn btn-primary">Login</button></div>
						</div>
						<div class="form-group">
							<a href="./register.php" style="color:white;">Not registered yet?</a>
						</div>
					</form>
				</div>	
			</div>
