...
<div class="dmn-content">
   <div class="dmn-page-box">
      <div class="dmn-page-title">
         <h1 style="font-family: Philosopher, sans-serif;color:white;">Highscores - Resets</h1>
      </div>
      <div class="dmn-page-content">
         ...
         <div class ="row">
            <div class="col-12">
               ...
               <div class="d-flex justify-content-center" style="font-family: Philosopher, sans-serif;color:white;font-weight:bold;">
                  <a href="./highscore.php" class="btn btn-primary" style="font-weight:bold;box-shadow: 0px 0px 5px #fff;"><img src="./images/reset.png" style="width: 35px; height 35px;">&nbsp;&nbsp;Resets</a>&nbsp;&nbsp;
                  <a href="./highscore-master.php" class="btn btn-primary"><img src="./images/master.png" style="width: 35px; height 35px;">&nbsp;Mastery</a>&nbsp;&nbsp;
         ...
         try {
            $sql = "SELECT race, name, level, reset, world FROM characters.character_info ORDER BY reset DESC LIMIT 50";
            ...
            if (mysqli_num_rows($result) > 0) {
               ...
               while($row = mysqli_fetch_assoc($result)) {
                  $location = "";
                  switch ($row["world"]) {case 0:$location = "Lorencia";break;case 1:$location = "Dungeon";break;case 2:$location = "Devias";break;case 3:$location = "Noria";break;case 4:$location = "Losttower";break;case 6:$location = "Arena";break;case 7:$location = "Atlans";break;case 8:$location = "Tarkan";break;case 9:$location = "Devilsquare";break;case 10:$location = "Icarus";break;case 11:case 12:case 13:case 14:case 15:case 16:case 17:$location = "Bloodcastle";break;case 18:case 19:case 20:case 21:case 22:case 23:$location = "Chaoscastle";break;case 24:case 25:case 26:case 27:case 28:case 29:$location = "Kalima";break;case 51:$location = "Elbeland";break;default:$location = "N/A";
                  }
                  $classname = "";
                  ...
                  if ($nr == 1) {
                     echo "<tr><td><img src='./images/gold-cup.png' style='width:30px; height:30px;'></td><td><img src='./images/classes/icon/".$row["race"].".png' style='width:30px; height:30px;'> ".$classname."</td><td>".$row["name"]."</td><td>".$row["reset"]."</td><td>".$location."</td></tr>";
                 
                  } else if ($nr == 2) {
                     echo "<tr><td><img src='./images/silver-cup.png' style='width:30px; height:30px;'></td><td><img src='./images/classes/icon/".$row["race"].".png' style='width:30px; height:30px;'> ".$classname."</td><td>".$row["name"]."</td><td>".$row["reset"]."</td><td>".$location."</td></tr>";
                 
                  } else if ($nr == 3) {
                     echo "<tr><td><img src='./images/bronze-cup.png' style='width:30px; height:30px;'></td><td><img src='./images/classes/icon/".$row["race"].".png' style='width:30px; height:30px;'> ".$classname."</td><td>".$row["name"]."</td><td>".$row["reset"]."</td><td>".$location."</td></tr>";

                  } else {
                  echo "<tr><td>#".$nr."</td><td><img src='./images/classes/icon/".$row["race"].".png' style='width:30px; height:30px;'> ".$classname."</td><td>".$row["name"]."</td><td>".$row["reset"]."</td><td>".$location."</td></tr>";
                  }
                  $nr++;
               }
            } else {
